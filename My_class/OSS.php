...
class OSS
{
    ...
    const BUCKET_NAME = 'jiuxunmu-weixin';
    ...
    public function __construct($isInternal = false)
    {
        ...
        $this->city = env('OSS_CITY', '深圳');
        $this->networkType = env('OSS_NETWORK_TYPE', '经典网络');
        $this->AccessKeyId = env('OSS_ACCESS_KEY', '');
        $this->AccessKeySecret = env('OSS_ACCESS_KEY_SECRET', '');
        $this->bucketName = env('OSS_BUCKET', '');
