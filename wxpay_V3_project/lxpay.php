...
<html>
	...
	?>
        <title><?php echo $WIDtotal_fee;?></title>
        ...
        <script Language="javascript">
            ...
            {//替换partnerkey
                return "4c45cdb2c20769b481f469952a952800";
            }
			
            function getAppId()
            {//替换appid
                return "wx05399835f11281d7";
            }
            
            function getAppKey()
            {//替换appkey
                return "7Xkakynopxcplr7Av1AdR6PQBYlDtulMES5s96JBiuP1KsJd1kXeSyojMCDU1KFikaxYCkMgHlcRYe8fDWYJGJLT1o1430WhfgBMCZmkUzaLVEemkwG7K0xQSZd48Pq3";
            }		
			//修改到此结束
            ...
            {
                var banktype = "WX";
                var body = "<?php echo $WIDsubject;?>";//商品名称信息，这里由测试网页填入。
                var fee_type = "1";//费用类型，这里1为默认的人民币
                var input_charset = "UTF-8";//字符集，可以使用GBK或者UTF-8
                var notify_url = "http://www.xingyatrip.com/dwxpay/huid/huidiao.php";//支付成功后将通知该地址
                ...
                var total_fee = <?php echo $WIDtotal_fee;?>00;//总金额。
    ...
    <body>
        ...
        <a id="getBrandWCPayRequest" href="javascript:void(0);"><h1 class="title"><img src="images/qrzf.jpg" style="width:100%;"></h1></a>        </div>
