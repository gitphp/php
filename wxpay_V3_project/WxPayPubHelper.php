...
// echo WxPayConf_pub::KEY;
// echo WxPayConf_pub::CURL_TIMEOUT;
// echo WxPayConf_pub::NOTIFY_URL;
// echo WxPayConf_pub::JS_API_CALL_URL;
// echo WxPayConf_pub::APPSECRET;
// echo WxPayConf_pub::MCHID;
// $test = new $WxPayConf_pub;
// var_dump($test);die();
/**
 * 所有接口的基类
 */
...
class UnifiedOrder_pub extends Wxpay_client_pub {
	...
	function createXml() {
		...
		{//var_dump($this->parameters);exit;
			...
			$this->parameters["appid"] = $this->payinfo['appid']; //公众账号ID
			$this->parameters["mch_id"] = $this->payinfo['mchid']; //商户号
			$this->parameters["spbill_create_ip"] = $_SERVER['REMOTE_ADDR']; //终端ip
			$this->parameters["nonce_str"] = $this->createNoncestr(); //随机字符串
			$this->parameters["sign"] = $this->getSign($this->parameters, $this->payinfo['key']); //签名
			return $this->arrayToXml($this->parameters);
	...
	function getPrepayId() {
		...
		if (isset($this->result["prepay_id"])) {
			return array('ret' => 0, 'data' => $this->result["prepay_id"]);
		} else {
			return array('ret' => 2, 'data' => $this->result["err_code_des"]);
		}
...
class Wxpay_server_pub extends Common_util_pub {
	...
	function checkSign() {
		$tmpData = $this->data;
		unset($tmpData['sign']);
		$sign = $this->getSign($tmpData, $this->payinfo['key']); //本地签名
		//file_put_contents('./upload/notify_url.txt',$sign."\n",FILE_APPEND);
...
class JsApi_pub extends Common_util_pub {
	...
	function createOauthUrlForCode($redirectUrl) {
		$urlObj["appid"] = $this->payinfo['appid'];
	...
	function createOauthUrlForOpenid() {
		$urlObj["appid"] = $this->payinfo['appid'];
		$urlObj["secret"] = $this->payinfo['appsecret'];
	...
	public function getParameters() {
		$jsApiObj["appId"] = $this->payinfo['appid'];
		$timeStamp = time();
		$jsApiObj["timeStamp"] = "$timeStamp";
		$jsApiObj["nonceStr"] = $this->createNoncestr();
		$jsApiObj["package"] = "prepay_id=$this->prepay_id";
		$jsApiObj["signType"] = "MD5";
		$jsApiObj["paySign"] = $this->getSign($jsApiObj, $this->payinfo['key']);
