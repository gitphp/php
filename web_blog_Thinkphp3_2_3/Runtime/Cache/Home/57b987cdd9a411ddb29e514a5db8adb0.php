...
<link rel="stylesheet" href="/Public/Css/my.css" />
	...
	<ol class="breadcrumb">
		  ...
		  <li class="active"><?php echo ($albums["al_name"]); ?></li>
	</ol>
	<div class="col-md-8 row-l">
		<div class="row album-look">
		<?php if(is_array($pictureList)): $i = 0; $__LIST__ = $pictureList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="col-xs-6 col-md-3">
		  <a class="fancybox-buttons thumbnail preview" data-fancybox-group="button" href="<?php echo ($v["p_img"]); ?>"><img src="<?php echo ($v["p_thumb"]); ?>" alt="<?php echo ($v["p_remark"]); ?>" /></a>
    ...
    <div class="home-from">
        ...
        <div class="collapse" id="collapseExample">
			...
			<input id="jump" type="hidden"  value="/album-1.html" />
