...
<article class="blogs">
<h1 class="t_nav"><span>“程序员生活”，技术不断更新，不断提高自己，在技术中找到自己。</span>
  <a href="/" class="n1">网站首页</a><a href="#" class="n2">慢生活</a></h1>
...
<?php foreach($cats as $k=>$v):?>
  ...
  <?php if($v['id']==9):?>
  <a href="/index.php/Home/Life/xc" target="_blank">
    <?php echo $v['catname'];?>
  <?php else:?>
  <a href="/index.php/Home/Life/index/id/<?php echo $v['id'];?>" target="_blank">
  <?php echo $v['catname'];?>
  <?php endif;?>
  </a>
  </li>
